...
Switch between tabs with Alt+Tab, ordered by last use. Like your OS application switcher, but for browser tabs.
...
- There is a full page Tab Manager that can be used as a New Tab page.
- Save collections of tabs in the tab manager, and reopen them later.
