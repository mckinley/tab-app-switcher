        ...
        {tabs.length === 0 ? (
          ...
          <div className="flex gap-0 overflow-x-auto scrollbar-hide">
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute right-2 flex-shrink-0 w-4 h-4 rounded-sm flex items-center justify-center opacity-0 group-hover:opacity-100 hover:bg-muted transition-all z-20"
            ...
            {canAddTab && (
              <button
                onClick={onAddTab}
                className="flex items-center justify-center px-4 flex-shrink-0 w-12 h-12 border-b-2 border-r border-border/10 border-b-transparent hover:border-b-muted-foreground/30 hover:bg-muted/50 transition-all text-muted-foreground hover:text-foreground"
