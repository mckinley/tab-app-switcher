/**
 * Utility functions for validating keyboard settings
...
/**
 * Validate a keyboard key combination
 */
export function validateKey(modifier: string, key: string, purpose: string): KeyboardValidationResult {
...
/**
 * Validate all keys in a KeyboardSettings object
 */
export function validateKeyboard(keyboard: {
  ...
  // Validate each key
  const results = [
    validateKey(keyboard.modifier, keyboard.activateForward, "Activate Forward"),
    validateKey(keyboard.modifier, keyboard.activateBackward, "Activate Backward"),
    validateKey(keyboard.modifier, keyboard.closeTab, "Close Tab"),
    validateKey(keyboard.modifier, keyboard.search, "Search"),
  ]
  ...
  const keys = [keyboard.activateForward, keyboard.activateBackward, keyboard.closeTab, keyboard.search]
...
/**
 * Get a user-friendly warning message for a key combination
 */
export function getKeyWarning(modifier: string, key: string): string | null {
  const result = validateKey(modifier, key, "Key")
