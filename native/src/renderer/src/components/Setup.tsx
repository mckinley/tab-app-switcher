...
export const Setup = ({ onOpenExternal, getConnectionStatus }: SetupProps): JSX.Element => {
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Browser extensions connected to this app
          </p>
        </div>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-muted/50 rounded-lg p-4 space-y-3">
          ...
          <div className="flex gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Keep this native app running in your menu bar
            </p>
          </div>
          <div className="flex gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Press{' '}
              <kbd className="px-1.5 py-0.5 bg-background rounded text-xs font-mono">Alt+Tab</kbd>{' '}
              to switch between your browser tabs like native apps
            </p>
          </div>
        </div>
      </div>
...
function ChromeIcon({ className }: { className?: string }): JSX.Element {
  return (
...
function FirefoxIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2" />
      <path
...
function EdgeIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2" />
...
function SafariIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2" />
