...
echo "    • Bump version in extension/package.json"
echo "    • Increment build number (or it auto-increments with patch version)"
echo "    • Run: npm run build:safari && npm run convert:safari"
echo ""
echo "  In Xcode:"
